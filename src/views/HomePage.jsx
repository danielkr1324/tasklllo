    ...
    return (
        <section className="home-page ">
            <header className="home-header ">
                ...
                <nav>
                    <NavLink to="/board/b101" >temp board</NavLink>
                    <NavLink to="/login" >Log In</NavLink>
                    <NavLink to="/signup"> <button className="btn-signup"> Get Taskllo for free</button></NavLink>
                </nav>
            </header>
                ...
                <section className="home-hero-container full">
                    <div className="hero-content ">
                        <div className="hero-text">
                            ...
                            <NavLink to="/about"> <button className="btn-signup">Sign up - I'ts free!</button></NavLink>
                        </div>
